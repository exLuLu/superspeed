...
checkspeedtest() {
	if  [ ! -e './speedtest-cli/speedtest' ]; then
		...
		wget --no-check-certificate -qO speedtest.tgz https://install.speedtest.net/app/cli/ookla-speedtest-1.1.1-$(uname -m)-linux.tgz > /dev/null 2>&1
	fi
...
preinfo() {
	...
	echo "       bash <(curl -Lso- https://git.io/sptestng)"
	echo "       全部节点列表:  https://git.io/superspeedList"
	echo "       节点更新: 2020/04/09  | 脚本更新: 2021/07/11"
	echo "——————————————————————————————————————————————————————————"
}
